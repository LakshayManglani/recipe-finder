...
export function createCard(recipe: Recipe) {
  const recipeContainer =
    utilityFunction.createElementWithPropertiesAndAttributes('section', {
      className: 'recipe_-container',
    });

  const recipeImageContainer =
    utilityFunction.createElementWithPropertiesAndAttributes('div', {
      className: 'recipe_-image_-container',
    });

  const recipeImage = utilityFunction.createElementWithPropertiesAndAttributes(
    'img',
    {
  ...
  const recipeTimeContainer =
    utilityFunction.createElementWithPropertiesAndAttributes('div', {
      className: 'recipe_-time_-container',
    });

  const recipeTime = utilityFunction.createElementWithPropertiesAndAttributes(
    'div',
    {
  ...
  const recipeName = utilityFunction.createElementWithPropertiesAndAttributes(
    'p',
    {
